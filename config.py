...
class Settings:
    ...
    jina_reader_fallback: bool = True
    jina_reader_timeout_seconds: int = 45
    jina_max_fallback_pages: int = 18
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            jina_reader_fallback=_env_bool("JINA_READER_FALLBACK", True),
            jina_reader_timeout_seconds=_env_int(
                "JINA_READER_TIMEOUT", 45, 10, 120
            ),
            jina_max_fallback_pages=_env_int(
                "JINA_MAX_FALLBACK_PAGES", 18, 1, 50
            ),
        )
    ...
    def resolved_mediawiki_api_url(self) -> str:
        ...
        # Lexicanum publishes /mediawiki/ as its API entry point.
